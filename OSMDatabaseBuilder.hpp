...
public:
	...
	OSMNode* currentNode() const { return currentNode_; }
	...
	OSMWay* currentWay() const { return currentWay_; }
	...
	OSMRelation* currentRelation() const { return currentRelation_; }
	...
	OSMEntity* currentEntity() const { return currentEntity_; }


	// Interaction with the key-value tables
	BoundKeyValueTable& nodeTags(){ return nodeTags_; }
	BoundKeyValueTable& wayTags(){ return wayTags_; }
	BoundKeyValueTable& relationTags(){ return relationTags_; }

	ValueTable& relationMemberRoles(){ return relationMemberRoles_; }
...
template<>inline void OSMDatabaseBuilder::createNew<OSMNode>(){ addNode(); }
template<>inline void OSMDatabaseBuilder::createNew<OSMRelation>(){ addRelation(); }
template<>inline void OSMDatabaseBuilder::createNew<OSMWay>(){ addWay(); }

template<>inline void OSMDatabaseBuilder::finishEntity<OSMNode>(){ currentEntity_=currentNode_=nullptr; }
template<>inline void OSMDatabaseBuilder::finishEntity<OSMRelation>(){ currentEntity_=currentRelation_=nullptr; }
template<>inline void OSMDatabaseBuilder::finishEntity<OSMWay>(){ currentEntity_=currentWay_=nullptr; }
